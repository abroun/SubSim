...
#ifndef CAMERA_SCENE_NODE_ANIMATOR_H
#define CAMERA_SCENE_NODE_ANIMATOR_H
...
namespace scene
{
    ...
    */
    class CameraSceneNodeAnimator : public ISceneNodeAnimatorCameraMaya 
    {
    public:
        //! Constructor
        CameraSceneNodeAnimator(gui::ICursorControl* cursor, 
...
#endif // CAMERA_SCENE_NODE_ANIMATOR_H
